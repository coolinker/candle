...
module.exports = class MatchAnalyser {
    ...
    generateConditionCombinations(buflen, data, filterFun, callback) {
    ...
    searchBullConditions(statusArr, bullRate, minNumer, reFilter) {
        ...
        let sublen = this.matchConditionsCount + 1;
        let totalcases = statusArr.length / sublen;
    ...
    filterValidRanges(idx, secBullBearMap, bullrate, minNumber, remap) {
        let re = { '1': 0, '0': 0, '-1': 0 };
        let arr = [];
